...
export default function Skill() {
  ...
  const skill = [
    {
      name: "Installing/Configuring Software",
      years: "10Years",
    ...
    {
      name: "File Systems & Backups",
      years: "3 Years",
      icon: "devicon-docker-plain",
    }, // not perfect, but close feel
    {
    ...
    {
      name: "PC Maintenance & Cleanup",
      years: "2 Years",
      icon: "devicon-linux-plain",
    }, // again, similar context
    {
      name: "Typing & Productivity Tools",
      years: "2 Years",
